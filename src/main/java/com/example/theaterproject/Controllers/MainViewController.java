 ...
 * This includes loading and displaying a grid of movie cards and handling user interactions such as signing out.
 *
 * The controller primarily interacts with the `movieGridPane` to display movie information and utilizes
 * the `MovieService` singleton to retrieve the list of movies. It uses FXML annotations for initializing
 * and managing UI elements.
 */
